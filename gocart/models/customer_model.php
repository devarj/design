	...
	********************************************************************/
	...
	function save($customer)
	{
		...
		else
		{
            ...
            $coupon['code'] = $this->config->item('coupon_reg_prefix').substr(date('U').$id, $this->config->item('code_max_number'));
            $coupon['start_date'] = date('Y-m-d');
            $coupon['reduction_amount'] = $this->config->item('coupon_reg_amount');
