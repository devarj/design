...
class Categories extends Admin_Controller {
    ...
    function index() {
        ...
        $data['categories'] = $this->Category_model->get_admin_categories_tierd();
    ...
    function form($id = false) {
        ...
        if ($id) {
            ...
            $data['reward_points'] = number_format($category->reward_points);
            $data['reward_price'] = number_format($category->reward_price);
        }
        ...
        $this->form_validation->set_rules('reward_points', 'Reward Points', 'trim|integer');
        $this->form_validation->set_rules('reward_price', 'Reward Price', 'trim|integer');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $save['slug'] = $slug;
            $save['reward_price'] = ($this->input->post('reward_price') == '') ? 0 : $this->input->post('reward_price');
            $save['reward_points'] = ($this->input->post('reward_points') == '') ? 0 : $this->input->post('reward_points');
    ...
    function update_enable(){
        $this->Category_model->update_category($this->input->post('enable'),$this->input->post('id'));
    }
