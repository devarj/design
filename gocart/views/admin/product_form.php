...
$(document).ready(function() {
	...
	$('#stock_id').change(function(){
		...
		$.ajax({
			url: '<?php echo base_url('admin/products/getstockvalue'); ?>/'+id,
...
<div class="row">
	<div class="span8">
		...
		<div class="tab-content">
						...
						<fieldset>
							...
							<div class="row" style="padding-top:10px;">
								<div class="span2">
									...
									<input type="text" readonly id="svalue" value="<?php echo $stock; ?>"/>
								</div>
							</div>
							<div class="row" style="padding-top:10px;">
								<div class="span2">
									<label for="quantity">Stock By</label>
									<?php
									...
									<select name="stock_id" id="stock_id">
										...
										<?php
											...
											foreach($itemtype as $it){
												...
												echo '<option value="'.$it->id.'" '.$selected.'>'.$it->name.'</option>';
											}
										?>
									</select>
								</div>
			...
			<div class="tab-pane" id="product_categories">
				<div class="row">
					<div class="span8">
						<label><strong>Search for Category</strong></label>
					</div>
				</div>
				<div class="row">
					...
					<div class="span2" style="text-align:center">
						<div class="row">
							<div class="span2">
								...
								{
									$.post("<?php echo site_url($this->config->item('admin_folder').'/products/product_autocomplete/');?>", { name: $('#product_search').val(), limit:10, id: <?php echo $id;?>},
										function(data) {
	...
	<div class="span4">
		...
		<label for="unit"><?php //echo lang('unit');?> <?php //echo lang('unit_sample');?></label>
		<?php
		$data	= array('name'=>'unit', 'value'=>set_value('unit', $unit), 'class'=>'span4');
		//echo form_input($data);?>
