...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container" style="line-height: 73px;">
			...
			<a class="brand" href="<?php echo $admin_url;?>"><img src="<?php 
				echo (gethostname() == 'PH-PC395') ? '' : base_url('gocart/themes/default/assets/images/logo.png'); ?>" style="max-width: 95px; width: 100%;"></a>
			
			<div class="nav-collapse">
				<ul class="nav" style="padding: 30px 15px 10px;">
					...
					if($this->auth->check_access('Admin')) : ?>
							...
							<li><a href="<?php echo $admin_url;?>items">Item Supplies</a></li>
							<li><a href="<?php echo $admin_url;?>sproducts">Supplier Products</a></li>
							<li><a href="<?php echo $admin_url;?>pos">Purchase Orders</a></li>
							<li><a href="<?php echo $admin_url;?>stocks">Stocks</a></li>
							<li><a href="<?php echo $admin_url;?>designs">Designs</a></li>
					<?php else: ?>
							<li><a href="<?php echo $admin_url;?>sproducts">Supplier Products</a></li>
							<li><a href="<?php echo $admin_url;?>spos">Purchase Orders</a></li>
					<?php endif; ?>	
							<?php
					// Restrict access to Admins only
					if($this->auth->check_access('Admin')) : ?>
						<!--	<li><a href="<?php echo $admin_url;?>digital_products"><?php echo lang('common_digital_products') ?></a></li>
							<li><a href="<?php echo $admin_url;?>suggested_products"><?php echo 'Suggested Products'; ?></a></li>-->
					<?php endif; ?>
						</ul>
					</li>
					<?php
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo $admin_url;?>tips">Tips Section</a></li>
							<li><a href="<?php echo $admin_url;?>freebies">Freebies</a></li>-->
						</ul>
					</li>
				...
				<ul class="nav pull-right actCont" style="padding: 30px 15px 10px;">
					<li class="dropdown">
