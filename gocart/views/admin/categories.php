			...
			<tr>
				...
				<td>
					<div class="btn-group" style="float:right">
                        ...
                        <a class="btn btn-danger enable" name="<?php echo $cat['category']->id; ?>"><?php echo ($cat['category']->enable == 1) ? 'Activated' : 'Deactivated';?></a>
					</div>
				</td>
			</tr>
			<?php
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       $('.enable').click(function(){
           ...
           var values = "enable="+valueID+"&id="+$(this).attr("name");

           $(this).text(valueID=='0' ? "Deactivated" : "Activated");

           $.ajax({
               type: "POST",
               url: "<?php echo base_url().$this->config->item('admin_folder'); ?>/categories/update_enable",
               data: values,
               cache: false,
               error: function(ts){
