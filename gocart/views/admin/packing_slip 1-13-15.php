...
<?php echo theme_css('akari-newdesign.css', true);?>
</head>

<body style=" background: #E2E1E1;">
    ...
    <table width="100%" style="">
        <tr>
            <td colspan="4" width="50%" style="padding: 10px 0;" >
               <img src="<?php echo base_url('gocart/themes/default/assets/images/akari-logo-admin.JPG'); ?>" style="float:left; max-width: 200px; height: 49px;">            
                <img src="<?php echo base_url('gocart/themes/default/assets/images/88db_corporate.png');?>" style="float:left; height: 30px; margin-top: 1.3em; margin-left: 10px">  
        ...
        <tr style="border-bottom:5px solid #E2E1E1; vertical-align:top;">
            <td colspan="2" width="50%" style="border:2px solid  #E2E1E1; padding: 10px 5px; line-height:1rem;">
                ...
                <span style="font-size:1.1em;"><?php echo $order->pickup_person; ?></span>
                <br/><br/><br/>

                <p style="margin-bottom:3px; font-size:9px;">PICKUP LOCATION:</p>
                <span style="font-size:1.1em;"><?php echo $order->pickup_loc; ?></span>
                <br/><br/><br/>

                <p style="margin-bottom:3px; font-size:9px;">PICKUP DATE & TIME:</p>
                <span style="font-size:1.1em;"><?php echo $order->pickup_date.' '.$order->pickup_time; ?></span>
                <br/><br/><br/>

                <p style="margin-bottom:3px; font-size:9px;">PHONE NUMBER:</p>
                <span style="font-size:1.1em;"><?php echo $order->pickup_contact; ?></span>
                <br/><br/><br/>
            ...
            <td colspan="2" width="50%" style="border:2px solid  #E2E1E1; padding: 10px 5px; line-height:1rem;">
                ...
                <span style="font-size:1.1em;"><?php echo $order->ship_firstname . ' ' . $order->ship_lastname; ?></span>
                <br/><br/><br/>

                <p style="margin-bottom:3px; font-size:9px;">SHIPPING ADDRESS:</p>
                <span style="font-size:1.1em;line-height: 1.2em;">
                ...
                <span style="font-size:1.1em;"><?php echo $order->ship_email; ?></span>
                <br/><br/><br/>

                <p style="margin-bottom:3px; font-size:9px;">PHONE NUMBER:</p>
                <span style="font-size:1.1em;"><?php echo $order->ship_phone; ?></span>
                <br/><br/>
        ...
        <tr style="border-bottom:5px solid #E2E1E1;">
            <td style="border:2px solid  #E2E1E1;padding: 5px; line-height:1rem; width:25%;">
                ...
                <span style="font-size:13px;"><?php echo format_currency($order->subtotal); ?></span>
            </td>
            <td style="border:2px solid  #E2E1E1;padding: 5px; line-height:1rem; width:25%;">
                <p style="margin-bottom:10px; font-size:9px;">SPECIAL INSTRUCTION:</p>
                <span style="font-size:13px;">FRAGILE</span>
            </td>
            <td style="border:2px solid  #E2E1E1;padding: 5px; line-height:1rem; width:25%;">
            ...
            <td style="border:2px solid  #E2E1E1;padding: 5px; line-height:1rem; width:25%;">
                <p style="margin-bottom:10px; font-size:9px;">ELECTRIC:</p>
                <span style="font-size:13px;"></span>
            </td>
        </tr>
        ...
        <tr>
            <td style="border-right:2px solid #E2E1E1; border-left:2px solid #E2E1E1; padding: 5px; line-height:1rem;">
                <span style="font-size:13px;"><?php echo $product['sku'];?></span>
            </td>
            <td style="border-right:2px solid #E2E1E1; border-left:2px solid #E2E1E1; padding: 5px; line-height:1rem;">
                <span style="font-size:13px;"><?php echo $product['name'];?></span>
            </td>
            <td style="border-right:2px solid #E2E1E1; border-left:2px solid #E2E1E1; padding: 5px; line-height:1rem;">
                <span style="font-size:13px;"><?php echo $product['quantity'];?></span>
            </td>
            <td style="border-right:2px solid #E2E1E1; border-left:2px solid #E2E1E1; padding: 5px; line-height:1rem;">
                <span style="font-size:13px;"><?php echo format_currency($product['price']*$product['quantity']);?></span>
            </td>
        </tr>
        <?php endforeach;?>
        <!-- Edit -->
