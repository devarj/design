      ...
      <div class="categoryPanel">
        <div class="side-col">
			...
			<tr>
			 ...
			 <tr>
				<td>
				<p>Price: <span id="pricing">200</span></p>
				<img src="<?php echo base_url('assets/img/ajax-loader.gif'); ?>" style="display:none;" class="loader" />
				<p class="order_number"></p>
				<input type="hidden" id="elemCount" value="0" /><input type="text" id="qty" placeholder="Quantity" /> <button id="generate" class="btn btn-info">Order This</button></td>
			 </tr>
            </table><br />
			...
			$(function(){
				...
				$('#generate').click(function(){
					...
					$.ajax({
						...
						data: 'data='+xx+'&qty='+qty+'&price='+price+'&count='+count,
						type: 'POST',
