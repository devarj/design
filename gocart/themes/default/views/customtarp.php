        ...
        <div class="side-col">
			...
			<tr>
				<td>
					<select id="size" class="form-control">
						...
						<option value="1 to 5 x 1 to 5">1 to 5 x 1 to 5 (PHP 250)</option>
						<option value="6 to 10 x 6 to 10">6 to 10 x 6 to 10 (PHP 350)</option>
						<option value="11 to 15 x 11 to 15">11 to 15 x 11 to 15 (PHP 450)</option>
					</select>
				</td>
			</tr>
			<tr>
			...
			<tr>
			 ...
			 <tr>
				...
				<input type="hidden" id="elemCount" value="0" /> <button id="generate" class="btn btn-info">Order This</button></td>
			 </tr>
            </table><br />
		...
		<script>
			$(function(){
				...
				$('#generate').click(function(){
					...
					$.ajax({
						url: '<?php echo base_url('cart/save_customtarp'); ?>',
						data: 'data='+xx+'&price='+price+'&size='+size,
						type: 'POST',
						success: function(data){
							$('.loader').hide();
							$('.order_number').html('Order successfully submitted. Your order number is <b>'+data+'</b>');
						},
						beforeSend: function(){
							$('.loader').show();
						}
